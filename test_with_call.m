...
[prob_cashlock1,prob_gapevent1,mean_Value1]=CPPI_with_call(T,dt,risk_free,S.first,Value_0,Strike,vol(1),nsim,nobs)
%Scenario 2: medium volatility
[prob_cashlock2,prob_gapevent2,mean_Value2]=CPPI_with_call(T,dt,risk_free,S.second,Value_0,Strike,vol(2),nsim,nobs)
%Scenario 3: high volatility
[prob_cashlock3,prob_gapevent3,mean_Value3]=CPPI_with_call(T,dt,risk_free,S.third,Value_0,Strike,vol(3),nsim,nobs)
